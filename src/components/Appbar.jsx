...
// const pages = ['main', 'profile', 'categories', 'registration'];
const pages = ['main', 'categories', 'list', 'products', 'registration'];
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box
            ...
            borderRadius="50%"
          >
            <TextField id="outlined-basic" label="Search for goods" variant="outlined" sx={{background: "#3c3c3c", color: "#ffffff", borderRadius: "5px"}}/>
          </Box>
          <Tooltip title="Open shopping cart">
          <Button variant="contained" sx={{m: 2, background: "#3c3c3c"}} startIcon={<ShoppingBasketIcon/>}> Cart</Button>
          </Tooltip>
          <Box sx={{ flexGrow: 0 }}>
